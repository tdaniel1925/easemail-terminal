...
-- The original policy had a circular dependency that caused infinite recursion
...
-- Organization Members table RLS policies (FIXED - No circular dependencies!)
...
-- FIXED: Simplified INSERT policy to avoid circular dependency
CREATE POLICY "organization_members_insert"
  ...
  WITH CHECK (
    ...
    -- Note: Removed the circular OWNER/ADMIN check
    -- Organization owners/admins should use the API which uses service role
  );
