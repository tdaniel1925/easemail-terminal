...
const welcomeTemplate = fs.readFileSync(path.join(__dirname, 'lib/email-templates/welcome.ts'), 'utf-8');
const passwordResetTemplate = fs.readFileSync(path.join(__dirname, 'lib/email-templates/password-reset.ts'), 'utf-8');
const organizationInviteTemplate = fs.readFileSync(path.join(__dirname, 'lib/email-templates/organization-invite.ts'), 'utf-8');
const notificationTemplate = fs.readFileSync(path.join(__dirname, 'lib/email-templates/notification.ts'), 'utf-8');
