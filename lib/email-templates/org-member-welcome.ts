        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);">
          ...
          <tr>
            <td style="background-color: #e8f0fe; padding: 40px 40px 60px 40px; text-align: center;">
              ...
              <h1 style="color: #1e3a8a; font-size: 32px; font-weight: bold; margin: 0 0 12px 0;">Welcome to the Team!</h1>
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px;">
                <tr>
                  <td style="padding: 24px; background-color: #e8f0fe; border-radius: 12px; border: 2px solid #10b981; text-align: center;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 20px;">
                <tr>
                  <td style="padding: 20px; background-color: #f0fdf4; border-radius: 12px; border-left: 4px solid #10b981;">
                    <h3 style="color: #1e3a8a; font-size: 16px; font-weight: 600; margin: 0 0 8px 0;">📧 Shared Email Management</h3>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 20px;">
                <tr>
                  <td style="padding: 20px; background-color: #f0fdf4; border-radius: 12px; border-left: 4px solid #14b8a6;">
                    <h3 style="color: #1e3a8a; font-size: 16px; font-weight: 600; margin: 0 0 8px 0;">🤝 Team Collaboration</h3>
                    <p style="color: #475569; font-size: 14px; line-height: 1.5; margin: 0;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 20px;">
                <tr>
                  <td style="padding: 20px; background-color: #f0fdf4; border-radius: 12px; border-left: 4px solid #06b6d4;">
                    <h3 style="color: #1e3a8a; font-size: 16px; font-weight: 600; margin: 0 0 8px 0;">🤖 AI-Powered Features</h3>
                    <p style="color: #475569; font-size: 14px; line-height: 1.5; margin: 0;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px;">
                <tr>
                  <td style="padding: 20px; background-color: #f0fdf4; border-radius: 12px; border-left: 4px solid #10b981;">
                    <h3 style="color: #1e3a8a; font-size: 16px; font-weight: 600; margin: 0 0 8px 0;">📊 View Your Activity</h3>
                    <p style="color: #475569; font-size: 14px; line-height: 1.5; margin: 0;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px;">
                <tr>
                  <td style="padding: 20px; background-color: #eff6ff; border-radius: 12px;">
                    <h3 style="color: #1e3a8a; font-size: 16px; font-weight: 600; margin: 0 0 12px 0;">🚀 Quick Start Guide</h3>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                <tr>
                  <td align="center">
                    <a href="https://easemail.app/app/organization/${organizationId}" style="display: inline-block; background-color: #e8f0fe; color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 8px; font-size: 16px; font-weight: 600;">
                      Go to Organization
                    </a>
                  </td>
                </tr>
