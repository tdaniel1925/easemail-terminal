        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);">
          ...
          <tr>
            <td style="background-color: #e8f0fe; padding: 40px 40px 60px 40px; text-align: center;">
              ...
              <h1 style="color: #1e3a8a; font-size: 32px; font-weight: bold; margin: 0 0 12px 0;">Welcome to ${organizationName}!</h1>
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px;">
                <tr>
                  <td style="padding: 24px; background-color: #e8f0fe; border-radius: 12px; border: 2px solid #d946ef;">
                    <h3 style="color: #1e3a8a; font-size: 18px; font-weight: 600; margin: 0 0 16px 0;">📋 Your Organization Details</h3>
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding: 8px 0; color: #475569; font-size: 14px;">Organization:</td>
                        <td style="padding: 8px 0; color: #1e3a8a; font-size: 14px; font-weight: 600; text-align: right;">${organizationName}</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="padding: 8px 0; color: #475569; font-size: 14px;">Seats Available:</td>
                        <td style="padding: 8px 0; color: #1e3a8a; font-size: 14px; font-weight: 600; text-align: right;">${seats}</td>
                      </tr>
                      <tr>
                        <td style="padding: 8px 0; color: #475569; font-size: 14px;">Your Role:</td>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 20px;">
                <tr>
                  <td style="padding: 20px; background-color: #f8fafc; border-radius: 12px; border-left: 4px solid #7c3aed;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td style="vertical-align: top;">
                          <h3 style="color: #1e3a8a; font-size: 16px; font-weight: 600; margin: 0 0 8px 0;">👥 Invite Your Team Members</h3>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 20px;">
                <tr>
                  <td style="padding: 20px; background-color: #f8fafc; border-radius: 12px; border-left: 4px solid #a855f7;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="width: 30px; vertical-align: top;">
                        ...
                        <td style="vertical-align: top;">
                          <h3 style="color: #1e3a8a; font-size: 16px; font-weight: 600; margin: 0 0 8px 0;">📧 Connect Email Accounts</h3>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 20px;">
                <tr>
                  <td style="padding: 20px; background-color: #f8fafc; border-radius: 12px; border-left: 4px solid #d946ef;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="width: 30px; vertical-align: top;">
                        ...
                        <td style="vertical-align: top;">
                          <h3 style="color: #1e3a8a; font-size: 16px; font-weight: 600; margin: 0 0 8px 0;">⚙️ Configure Organization Settings</h3>
                          <p style="color: #475569; font-size: 14px; line-height: 1.5; margin: 0;">
                  ...
                  <td style="padding: 20px; background-color: #f8fafc; border-radius: 12px; border-left: 4px solid #7c3aed;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td style="vertical-align: top;">
                          <h3 style="color: #1e3a8a; font-size: 16px; font-weight: 600; margin: 0 0 8px 0;">💳 Review Billing Details</h3>
                          <p style="color: #475569; font-size: 14px; line-height: 1.5; margin: 0;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px;">
                <tr>
                  <td style="padding: 20px; background-color: #fefce8; border-radius: 12px; border: 2px solid #eab308;">
                    <h3 style="color: #1e3a8a; font-size: 16px; font-weight: 600; margin: 0 0 12px 0;">👑 Your Owner Privileges</h3>
                    <p style="color: #475569; font-size: 14px; line-height: 1.6; margin: 0 0 8px 0;">As the owner, only you can:</p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                <tr>
                  <td align="center">
                    <a href="https://easemail.app/app/organization/${organizationId}/dashboard" style="display: inline-block; background-color: #e8f0fe; color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 8px; font-size: 16px; font-weight: 600;">
