        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);">
          ...
          <tr>
            <td style="background-color: #e8f0fe; padding: 40px 40px 60px 40px; text-align: center;">
              ...
              <h1 style="color: #1e3a8a; font-size: 32px; font-weight: bold; margin: 0 0 12px 0;">You're an Admin!</h1>
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 20px;">
                <tr>
                  <td style="padding: 20px; background-color: #ecfeff; border-radius: 12px; border-left: 4px solid #0ea5e9;">
                    <h3 style="color: #1e3a8a; font-size: 16px; font-weight: 600; margin: 0 0 8px 0;">👥 Manage Members</h3>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 20px;">
                <tr>
                  <td style="padding: 20px; background-color: #ecfeff; border-radius: 12px; border-left: 4px solid #06b6d4;">
                    <h3 style="color: #1e3a8a; font-size: 16px; font-weight: 600; margin: 0 0 8px 0;">📊 View Analytics</h3>
                    <p style="color: #475569; font-size: 14px; line-height: 1.5; margin: 0;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 20px;">
                <tr>
                  <td style="padding: 20px; background-color: #ecfeff; border-radius: 12px; border-left: 4px solid #14b8a6;">
                    <h3 style="color: #1e3a8a; font-size: 16px; font-weight: 600; margin: 0 0 8px 0;">⚙️ Configure Settings</h3>
                    <p style="color: #475569; font-size: 14px; line-height: 1.5; margin: 0;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px;">
                <tr>
                  <td style="padding: 20px; background-color: #ecfeff; border-radius: 12px; border-left: 4px solid #0ea5e9;">
                    <h3 style="color: #1e3a8a; font-size: 16px; font-weight: 600; margin: 0 0 8px 0;">🔐 Moderate Content</h3>
                    <p style="color: #475569; font-size: 14px; line-height: 1.5; margin: 0;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px;">
                <tr>
                  <td style="padding: 20px; background-color: #f0f9ff; border-radius: 12px;">
                    <h3 style="color: #1e3a8a; font-size: 16px; font-weight: 600; margin: 0 0 12px 0;">🚀 Getting Started as an Admin</h3>
