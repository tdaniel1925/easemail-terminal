-- ============================================
-- EASEMAIL DATABASE SETUP - COMPLETE SCHEMA
-- ============================================
-- Run this in Supabase SQL Editor:
-- https://supabase.com/dashboard/project/bfswjaswmfwvpwvrsqdb/sql
-- ============================================
...
CREATE TYPE feature_type AS ENUM ('ai_remix', 'ai_dictate', 'voice_message', 'sms', 'calendar_event', 'smart_compose', 'email_received');
...
-- 2. Close this SQL editor
-- 3. Go back to your terminal and run: npm run dev
-- ============================================
